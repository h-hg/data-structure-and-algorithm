...
AVL树的例子
![](avl-tree/avl-example.drawio.svg)
蓝色节点的高度不满足条件。
...
### LL 示例
![](avl-tree/ll-example.drawio.svg)
...
![](avl-tree/insert-example.drawio.svg)
...
```
调用示意图如下：
![](avl-tree/remove-min-example.drawio.svg)
