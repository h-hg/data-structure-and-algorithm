...
![](left-bound-close-search.drawio.svg)
...
![](left-bound-open-search.drawio.svg)
...
![](right-bound-close-search.drawio.svg)
...
类似的，C++ `alogirthm` 也有一个 `upper_bound`，用于查找第一个大于指定值的位置。
